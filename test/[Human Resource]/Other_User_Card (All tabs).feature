...
Функционал: <Human Resources. Проверка доступка к карточке чужогоо сотрудника (у которого в карточке проставлен другой HR>

Как <Human Resources>
Я хочу <иметь доступ к карточке чужого сотрудника> 

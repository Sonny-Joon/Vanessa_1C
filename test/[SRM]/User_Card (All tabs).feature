...
Сценарий: <описание сценария>
	...
	И из выпадающего списка с именем "ПоискСотрудник" я выбираю по строке 'корнилюк сер'
	Тогда открылось окно 'Корнилюк Сергей (Сотрудник)'
	...
	И Я закрываю окно 'Корнилюк Сергей (Сотрудник)'
